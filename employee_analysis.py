...
class EmployeeDataAnalyzer:
    ...
    def generate_recommendations(self):
        ...
        try:
            ...
            recommendations.append(f"1. Salary Equity: There's a ${salary_gap:.2f} gap between {max_salary_dept} and {min_salary_dept} departments. "
            ...
            if remote_stats[('salary', 'mean')]['Yes'] > remote_stats[('salary', 'mean')]['No']:
                recommendations.append("2. Remote Work Policy: Remote workers show higher average salaries. "
            ...
            if education_stats[('performance_score', 'mean')]['PhD'] > education_stats[('performance_score', 'mean')]['Bachelor']:
                recommendations.append("3. Education Investment: PhD holders show higher performance scores. "
            ...
            recommendations.append(f"4. Performance Improvement: {low_perf_dept} department shows lower average performance scores. "
